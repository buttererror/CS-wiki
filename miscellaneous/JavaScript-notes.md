...
The canonical explanation is now [Functions, Closures, and Identity](../computer-science-foundations/programming-languages/javascript/functions-closures-and-identity.md).
